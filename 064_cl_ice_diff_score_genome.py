...
print("===== 064_cl_ice_diff_score_genome.py - Starting =====")
...
# Variables
dataset = "cl_ice_diff"
nucleosome_std_relation = lambda MLEs, means : MLEs["k"] * F(
    MLEs["n"]*(means - MLEs["m"])
) + MLEs["l"]
model = "quadratic"
...
print("===== 064_cl_ice_diff_score_genome.py - Exiting Properly =====")