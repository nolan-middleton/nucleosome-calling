#############################################################################
# This file will place the nucleosomes using the scores for the cl_rt_log2  #
# model.                                                                    #
#############################################################################

print("===== 071_cl_rt_log2_nucleosome_placement.py - Starting =====")
...
print("===== 071_cl_rt_log2_nucleosome_placement.py - Exiting Properly =====")