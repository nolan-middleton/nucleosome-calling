#########################################################################
# This R script generates plots for the random CPD damage patterns for  #
# easy visualization.                                                   #
#########################################################################
...
for (I in 1:length(models)) {
  ...
  for (i in 0:(N-1)) {
    ...
    out_dir <- paste0("RandomPattern/", model, "/", toString(i))
    data <- read.delim(
      paste0(
        "RandomPattern/",
        model,
    ...
    ggplot(data = plotData, mapping = aes(x=x, y=mean, color=strand)) +
      ...
      ggtitle(paste0("Random Damage Pattern (", dataset_name, ")"))
    
    ggsave(
      paste0(out_dir, "/mean.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data=plotData, mapping=aes(x=x, y=var, color=strand)) +
      ...
      scale_color_discrete(type = colour_scale, name = "Strand") +
      scale_y_continuous(
        name = bquote("Standard Deviation of"~.(dataname))
      ) +
      scale_x_continuous(
        name = "Inbetween Position",
        breaks = c(seq(-73,0,5),0,seq(3,73,5)),
    ...
    ggsave(
      paste0(out_dir, "/mean_aligned.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    # Mean-Variance Plot
    ggplot(data=plotData, mapping=aes(x=mean, y=var, color=strand)) +
      geom_point(size = 0.5) +
      scale_color_discrete(type = colour_scale, name = "Strand") +
      scale_x_continuous(name = bquote("Mean"~.(dataname))) +
      scale_y_continuous(name = bquote("Variance of"~.(dataname))) +
      ggtitle(paste0("Variance as Function of Mean\n(",dataset_name,")"))
    
    ggsave(
      paste0(out_dir, "/mean_var.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data=plotData) +
      ...
      ggtitle(
        paste0(
          "Standard Deviation as Function of Mean\n(",
          dataset_name,
          ")"
        )
      )
    ...
    ggsave(
      paste0(out_dir, "/mean_stderr.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data=plotData, mapping=aes(x=x,y=detrended)) +
      ...
      ggtitle(
        paste0("Detrended Random Damage Pattern\n(", dataset_name, ")")
      )
    
    ggsave(
      paste0(out_dir, "/detrended_mean.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data=plotData, mapping=aes(x=x,y=trended)) +
      ...
      ggtitle(
        paste0("Overall Random Damage Pattern\n(", dataset_name, ")")
      )
    
    ggsave(
      paste0(out_dir, "/overall_mean.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data = plotData, mapping = aes(x = x, y = variance)) +
      ...
      ggtitle(
        paste0("Overall Random Damage Variance\n(", dataset_name, ")")
      )
    
    ggsave(
      paste0(out_dir, "/composite_variance.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data = plotData, mapping = aes(x = trended, y = variance)) +
      ...
      ggtitle(
        paste0("Overall Random Damage Variance vs. Mean\n(", dataset_name, ")")
      )
    
    ggsave(
      paste0(out_dir, "/composite_mean_var.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
    ...
    ggplot(data = plotData, mapping = aes(x = trended, y = sqrt(variance))) +
      ...
      ggtitle(
        paste0("Overall Random Damage Standard Deviation vs. Mean\n(", dataset_name, ")")
      )
    
    ggsave(
      paste0(out_dir, "/composite_mean_std.png"),
      width = 2000,
      height = 1000,
      units = "px"
    )
