...
print("===== 100_cl_ice_abs_diff_score_genome_shuffled.py - Starting =====")
...
rng = np.random.default_rng(78236783423640378423)
...
#%% End
S="===== 100_cl_ice_abs_diff_score_genome_shuffled.py - Exiting Properly ====="
print(S)