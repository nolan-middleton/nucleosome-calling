#############################################################################
# This file will score the ENTIRE GENOME for the cl_rt_log2 model.          #
#############################################################################

print("===== 061_cl_rt_log2_score_genome.py - Starting =====")
...
random_std_relation = lambda MLEs, means : MLEs["k"] + np.zeros(len(means))
...
print("===== 061_cl_rt_log2_score_genome.py - Exiting Properly =====")