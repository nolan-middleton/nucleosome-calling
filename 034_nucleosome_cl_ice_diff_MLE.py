...
# cl_ice_diff model under a variety of different underlying likelihoods.    #
#############################################################################

print("===== 034_nucleosome_cl_ice_diff_MLE.py - Starting =====")
...
out_dir = "NucleosomePattern/cl_ice_diff/models"
...
print("===== 034_nucleosome_cl_ice_diff_MLE.py - Exiting Properly =====")