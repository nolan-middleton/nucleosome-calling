...
# cl model under a wide variety of different underlying likelihoods.        #
#############################################################################

print("===== 030_nucleosome_unfloored_cl_MLE.py - Starting =====")
...
out_dir = "NucleosomePattern/unfloored_cl/models"
...
data = nuc.load_nucleosome_pattern_dataset(
    "NucleosomePattern/unfloored_cl",
    nucChroms
)
...
print("===== 030_nucleosome_unfloored_cl_MLE.py - Exiting Properly =====")