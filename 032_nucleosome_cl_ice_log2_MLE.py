...
# cl_ice_log2 model under a variety of different underlying likelihoods.    #
#############################################################################

print("===== 032_nucleosome_cl_ice_log2_MLE.py - Starting =====")
...
def std_relation(A, means):
    ...
    sigma = k*(means - m)**2 + l
    '''
    return A[0]*(means - A[2])**2 + A[1]

out_dir = "NucleosomePattern/cl_ice_log2/models"
...
flat_hyper = nuc.hyperparameter_MLE(
    ...
    [offsets, X],
    std_relation,
    [flat_MLE["k"], flat_MLE["l"], flat_MLE["m"]]
)
...
linear_hyper = nuc.hyperparameter_MLE(
    ...
    std_relation,
    [linear_MLE["k"], linear_MLE["l"], linear_MLE["m"]]
)
...
quadratic_hyper = nuc.hyperparameter_MLE(
    ...
    std_relation,
    [quadratic_MLE["k"], quadratic_MLE["l"], linear_MLE["m"]]
)
...
print("===== 032_nucleosome_cl_ice_log2_MLE.py - Exiting Properly =====")