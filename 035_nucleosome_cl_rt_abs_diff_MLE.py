...
# cl_rt_abs_diff model under a variety of different underlying likelihoods. #
#############################################################################

print("===== 035_nucleosome_cl_rt_abs_diff_MLE.py - Starting =====")
...
out_dir = "NucleosomePattern/cl_rt_abs_diff/models"
...
data = nuc.load_nucleosome_pattern_dataset(
    "NucleosomePattern/cl_rt_abs_diff",
    nucChroms
)
...
print("===== 035_nucleosome_cl_rt_abs_diff_MLE.py - Exiting Properly =====")