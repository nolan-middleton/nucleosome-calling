...
# cl_ice_abs_diff model under a variety of different baseline likelihoods.  #
#############################################################################

print("===== 036_nucleosome_cl_ice_abs_diff_MLE.py - Starting =====")
...
out_dir = "NucleosomePattern/cl_ice_abs_diff/models"
...
print("===== 036_nucleosome_cl_ice_abs_diff_MLE.py - Exiting Properly =====")