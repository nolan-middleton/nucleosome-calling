#############################################################################
# This file will place the nucleosomes using the scores for the             #
# cl_ice_abs_diff model.                                                    #
#############################################################################

print("===== 076_cl_ice_abs_diff_nucleosome_placement.py - Starting =====")
...
S="===== 076_cl_ice_abs_diff_nucleosome_placement.py - Exiting Properly ====="
print(S)